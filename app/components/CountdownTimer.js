        ...
        renderer={({ days, hours, minutes, seconds }) => (
          <>
            <div className="flex flex-col items-center justify-center">
              <div className="bg-[rgba(255,255,255,0.6)] w-[86px] h-[75px] flex items-center justify-center rounded-lg">
                <span className="text-4xl text-[#F7A304] bg-gradient-to-r from-[#F7A304] to-[#E5570D] bg-clip-text text-transparent">
                  {days}
                </span>
              </div>
